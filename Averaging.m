...
%% Create storage variables, ONLY RUN ONCE!
tmax_varRR=cell(4,11);
jhalf_varRR=cell(4,11);
intrazeb1_varRR=cell(4,11);
intrasnail2_varRR=cell(4,11);
kDAE_varRR=cell(4,11);
ka_varRR=cell(4,11);
base_varRR=cell(1,11);
%%
...
%% End MCS values for scaling factors- 2 1x6 graphs
fa=24;
fb=fa+2;
fc=fa+2;
...
figure
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=tmax_var; % Specify variable
phenoend=zeros(2,5);
title1='T_{max}'; %Specify Variable Title
...
b = get(gca,'YTick');
set(gca,'YTick',b,'fontsize',fa-2)
leg=legend('0 TGF-?','5 TGF-?','FontSize',fa-2, 'Interpreter', 'tex');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=intrasnail2_var; % Specify variable
phenoend=zeros(2,5);
title1='kd_{s}'; %Specify Variable Title
...
subplot(2,3,2) % Specify plot number
plot(xval,phenoend(1,:),'-ob','MarkerFaceColor','b','LineWidth',2);
hold on
plot(xval,phenoend(2,:),'-or','MarkerFaceColor','r','LineWidth',2);
title([title1],'FontSize',fc,'FontWeight','bold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=ka_var; % Specify variable
phenoend=zeros(2,5);
title1='k_{a}'; %Specify Variable Title
...
subplot(2,3,3) % Specify plot number
plot(xval,phenoend(1,:),'-ob','MarkerFaceColor','b','LineWidth',2);
hold on
plot(xval,phenoend(2,:),'-or','MarkerFaceColor','r','LineWidth',2);
title([title1],'FontSize',fc,'FontWeight','bold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=jhalf_var2; % Specify variable
phenoend=zeros(2,5);
title1='J_{half}'; %Specify Variable Title
...
subplot(2,3,4) % Specify plot number
plot(xval,phenoend(1,:),'-ob','MarkerFaceColor','b','LineWidth',2);
hold on
plot(xval,phenoend(2,:),'-or','MarkerFaceColor','r','LineWidth',2);
title([title1],'FontSize',fc,'FontWeight','bold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=intrazeb1_var; % Specify variable
phenoend=zeros(2,5);
title1='kd_{z}'; %Specify Variable Title
...
subplot(2,3,5) % Specify plot number
plot(xval,phenoend(1,:),'-ob','MarkerFaceColor','b','LineWidth',2);
hold on
plot(xval,phenoend(2,:),'-or','MarkerFaceColor','r','LineWidth',2);
title([title1],'FontSize',fc,'FontWeight','bold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
graph_var=kDAE_var; % Specify variable
phenoend=zeros(2,5);
title1='kd_{AE}'; %Specify Variable Title
...
subplot(2,3,6) % Specify plot number
plot(xval,phenoend(1,:),'-ob','MarkerFaceColor','b','LineWidth',2);
hold on
plot(xval,phenoend(2,:),'-or','MarkerFaceColor','r','LineWidth',2);
title([title1],'FontSize',fc,'FontWeight','bold');
...
sizeend(1,3)=base_var{1,4}(end)*delx;
...
sizeend(2,3)=base_var{1,9}(end)*delx;
...
xticks(xval)
xticklabels({num2str(xval(1)),num2str(xval(2)),num2str(xval(3)),num2str(xval(4)),num2str(xval(5))})
yticks([minrange2 minrange2+rangediff/2 maxrange2])
yticklabels({num2str(minrange2) num2str(minrange2+rangediff/2) num2str(maxrange2)})
...
%% Visualize ECM Snapshots 6/2 *******************************************

load('test_100p_1204mcs_0tgfb_0.3tmax_0.06spread_targetscale2_Jhalf9574.3821_dividing1.25_extraA0.96_extraBT0.6_ZEBscale0.8_R200scale1.2_ZEB1_SNAIL1_TGFB.mat');
%%
tic
solTvar=zeros(100*100,1200);
solEvar=zeros(100*100,1200);
asmEvar=zeros(100*100,1200);
ecmTvar=zeros(100*100,1200);
for MCS=1:1200
